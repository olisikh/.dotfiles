...
`goal_complete` is exclusive to an active `/goal` session. Never call it merely because ordinary Build or Plan work is complete; finish those tasks with a normal assistant response.
